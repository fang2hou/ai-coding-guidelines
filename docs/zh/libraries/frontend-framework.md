...
优先采用——Vite 是默认前端框架;仅当确需其全栈能力时才选择 Next.js。

决策规则:

- 默认使用 Vite。
- 仅当项目需要全栈 React 应用,或所需能力足以证明选择 Next.js 合理时,才使用 Next.js。
...
- 应用是简单、快速的纯前端,用不着全栈框架。
- 不需要服务端渲染和全栈能力。

### Next.js

- 项目需要全栈 React 应用。
- 项目所需的能力确实足以证明选择 Next.js 合理。

## 不适用场景

### Vite

- 项目所需的全栈能力足以证明选择 Next.js 合理。
...
- 项目需要全栈 React 应用,或所需能力足以证明选择 Next.js 合理时,使用 Next.js。
