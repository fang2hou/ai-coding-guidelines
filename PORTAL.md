...
| Choose an implementation language | [typescript](./guidelines/en/toolchain/typescript.md) → [python](./guidelines/en/toolchain/python.md) → [go](./guidelines/en/toolchain/go.md) → [rust](./guidelines/en/toolchain/rust.md) (Mandate sections; TypeScript/Python are the defaults) |
| Start a Go or Rust service | Baseline + [mise](./guidelines/en/toolchain/mise.md) → [go](./guidelines/en/toolchain/go.md) or [rust](./guidelines/en/toolchain/rust.md) → [quality-gates](./guidelines/en/toolchain/quality-gates.md) → [git](./guidelines/en/toolchain/git.md) |
...
| [toolchain/go](./guidelines/en/toolchain/go.md) | Baseline Go standard (draft): golangci-lint, gofumpt, error and concurrency rules | Considering or writing Go |
| [toolchain/rust](./guidelines/en/toolchain/rust.md) | Baseline Rust standard (draft): cargo, clippy, rustfmt, unsafe policy | Considering or writing Rust |
